# Estudo de Caso: Sistema de Monitoramento de Risco Operacional
...
- Containerização (Docker) e deploy em nuvem
- Acesso direto da Yoyo ao banco de dados para análises históricas
